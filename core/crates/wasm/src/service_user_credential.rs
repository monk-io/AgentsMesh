...
impl WasmUserCredentialService {
    ...
    pub async fn list_git_credentials(&self) -> Result<String, String> {
        let resp = self.client.list_user_git_credentials().await.map_err(|e| e.to_string())?;
        serde_json::to_string(&resp).map_err(|e| e.to_string())
    }

    pub async fn create_git_credential(&self, json: &str) -> Result<String, String> {
        let req: CreateGitCredentialRequest = serde_json::from_str(json).map_err(|e| e.to_string())?;
        let resp = self.client.create_user_git_credential(&req).await.map_err(|e| e.to_string())?;
        serde_json::to_string(&resp).map_err(|e| e.to_string())
    }

    pub async fn get_git_credential(&self, id: i64) -> Result<String, String> {
        let resp = self.client.get_user_git_credential(id).await.map_err(|e| e.to_string())?;
        serde_json::to_string(&resp).map_err(|e| e.to_string())
    }

    pub async fn update_git_credential(&self, id: i64, json: &str) -> Result<String, String> {
        let req: UpdateGitCredentialRequest = serde_json::from_str(json).map_err(|e| e.to_string())?;
    ...
    pub async fn delete_git_credential(&self, id: i64) -> Result<(), String> {
        self.client.delete_user_git_credential(id).await.map_err(|e| e.to_string())?;
        Ok(())
    }

    pub async fn get_default_git_credential(&self) -> Result<String, String> {
        let resp = self.client.get_default_git_credential().await.map_err(|e| e.to_string())?;
        serde_json::to_string(&resp).map_err(|e| e.to_string())
    }
    ...
    pub async fn set_default_git_credential(&self, json: &str) -> Result<(), String> {
        ...
        self.client.set_default_git_credential(&req).await.map_err(|e| e.to_string())?;
        Ok(())
    }

    pub async fn clear_default_git_credential(&self) -> Result<(), String> {
        self.client.clear_default_git_credential().await.map_err(|e| e.to_string())?;
        Ok(())
    }
    ...
    pub async fn delete_agent_credential(&self, id: i64) -> Result<(), String> {
        self.client.delete_user_agent_credential(id).await.map_err(|e| e.to_string())?;
        Ok(())
    }

    pub async fn set_default_agent_credential(&self, id: i64) -> Result<(), String> {
        self.client.set_default_agent_credential(id).await.map_err(|e| e.to_string())?;
        Ok(())
    }
