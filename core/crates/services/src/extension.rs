...
impl ExtensionService {
    ...
    pub async fn list_skill_registries(&self) -> Result<String, String> {
        let resp = self.client.list_skill_registries().await.map_err(|e| e.to_string())?;
        serde_json::to_string(&resp).map_err(|e| e.to_string())
    }

    pub async fn create_skill_registry(&self, json: &str) -> Result<String, String> {
        let req: CreateSkillRegistryRequest = serde_json::from_str(json).map_err(|e| e.to_string())?;
        let resp = self.client.create_skill_registry(&req).await.map_err(|e| e.to_string())?;
        serde_json::to_string(&resp).map_err(|e| e.to_string())
    }

    pub async fn sync_skill_registry(&self, id: i64) -> Result<(), String> {
        self.client.sync_skill_registry(id).await.map_err(|e| e.to_string())?;
        Ok(())
    }

    pub async fn toggle_skill_registry(&self, id: i64, json: &str) -> Result<String, String> {
        let req: ToggleRegistryRequest = serde_json::from_str(json).map_err(|e| e.to_string())?;
        let resp = self.client.toggle_skill_registry(id, &req).await.map_err(|e| e.to_string())?;
        serde_json::to_string(&resp).map_err(|e| e.to_string())
    }

    pub async fn delete_skill_registry(&self, id: i64) -> Result<(), String> {
        self.client.delete_skill_registry(id).await.map_err(|e| e.to_string())?;
        Ok(())
    }

    pub async fn list_skill_registry_overrides(&self) -> Result<String, String> {
        let resp = self.client.list_skill_registry_overrides().await.map_err(|e| e.to_string())?;
        serde_json::to_string(&resp).map_err(|e| e.to_string())
    }
    ...
    pub async fn install_skill_from_market(
        ...
        let req: InstallMarketSkillRequest = serde_json::from_str(json).map_err(|e| e.to_string())?;
        let resp = self.client
    ...
    pub async fn install_skill_from_github(
        ...
        let req: InstallGithubSkillRequest = serde_json::from_str(json).map_err(|e| e.to_string())?;
        let resp = self.client
    ...
    pub async fn update_skill(
        ...
        let req: UpdateSkillInstallRequest = serde_json::from_str(json).map_err(|e| e.to_string())?;
        let resp = self.client
    ...
    pub async fn uninstall_skill(&self, repo_id: i64, install_id: i64) -> Result<(), String> {
        self.client.uninstall_skill(repo_id, install_id).await.map_err(|e| e.to_string())?;
        Ok(())
    }
    ...
    pub async fn install_mcp_from_market(
        ...
        let req: InstallMarketMcpRequest = serde_json::from_str(json).map_err(|e| e.to_string())?;
        let resp = self.client
    ...
    pub async fn install_custom_mcp_server(
        ...
        let req: InstallCustomMcpRequest = serde_json::from_str(json).map_err(|e| e.to_string())?;
        let resp = self.client
    ...
    pub async fn update_mcp_server(
        ...
        let req: UpdateMcpInstallRequest = serde_json::from_str(json).map_err(|e| e.to_string())?;
        let resp = self.client
