/**
 * Ticket ViewModels — UI-side projection of `proto.ticket.v1` types.
 *
 ...
 * (b) too many consumers (TicketCreateDialog, TicketDetailSidebar,
 * KanbanBoard, RelationsList, CommentsList, CommitsList, TicketIcons)
 * reference these fields directly. Adapters in `lib/api/ticket*.ts` map
 * the camelCase proto types onto these ViewModels.
 */
